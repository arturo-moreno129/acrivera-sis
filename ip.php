...
<!--<script>
    ...
    const names = ["DATALOADER", "MENSAJE BIENVENIDA", "FORTINET", "ACTIVE DIRECTORY", "COMPAQ", "IMPRESORA TORRE DE CONTROL", "IMPRESORA VENTAS AFUERA", "IMPRESORA CONTABILIDAD", "IMPRESORA RECURSOS HUMANOS", "IMPRESORA RECEPCIÓN", "IMPRESORA ALMACÉN", "IMPRESORA VENTAS ADENTRO", "IMPRESORA SERVICIO", "IMPRESORA HYP"]; //prueba
