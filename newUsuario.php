...
//$password = "inicio0525"; //$_POST['password'];
// Hasheamos la contraseña con un algoritmo seguro (por defecto, PASSWORD_BCRYPT)
//$hashed_password = password_hash($password, PASSWORD_DEFAULT);
//$query = "INSERT into usuario values(default,'BHernandez','Berenice','Hernández','Ponce','Customer Experience','Marketing','$hashed_password',2)";
